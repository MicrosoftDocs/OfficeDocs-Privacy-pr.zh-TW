...
- MOE150
- MET150
description: 瞭解如何使用 Microsoft Power Automate 協助您自動化 Priva 中的主體許可權要求的基本工作。
ms.openlocfilehash: 2e1fa97b9e2cc5889471fa163dec26a5a5e37d56
ms.sourcegitcommit: f145dff5e387a8e26db2f3a2c7de125978fbacc9
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/28/2022
ms.locfileid: "62248885"
---
# <a name="automate-tasks-in-subject-rights-requests"></a>自動化主體許可權要求中的工作 

Microsoft Power Automate 是一種工作流程服務，可在應用程式和服務間自動執行動作。 當您啟用 Microsoft Priva 主體權利要求的 Power Automate 流程時，您可以自動執行案例和使用者的重要工作，例如在 ServiceNow 中建立入場券或加入到期日的行事曆提醒。 若要深入瞭解 Power Automate，請流覽其[檔網站](/power-automate/getting-started)。

具有主體權力要求訂閱的客戶不需要另 Power Automate 授權，即可使用 Priva 的建議 Power Automate 範本。 您可以自訂這些範本，以支援您的組織及涵蓋核心主體權利要求案例。 如果您選擇在這些範本中使用特優 Power Automate 功能，請使用 Microsoft 365 規範連接器建立自訂範本，或在 Microsoft 365 中使用其他規範區域的 Power Automate 範本，您可能需要更多 Power Automate 授權。

## <a name="create-a-new-power-automate-flow-from-a-template"></a>從範本建立新的 Power Automate 流程

1. 在 [Microsoft 365 合規性中心](https://compliance.microsoft.com/)中，移至導覽的 [Priva] 區段，然後選取 [ **Priva 主體權力要求**]。
...
### <a name="power-automate-templates-in-priva"></a>Priva 中的 Power Automate 範本
