...
## <a name="learn-about-policies"></a>深入瞭解原則
...
1. [查看原則詳細資料](risk-management-policies-manage.md#view-policy-details)
...
**Microsoft** 檔：取得 microsoft Priva 的運作方式，以及如何為您的組織最好的實施方式的詳細資訊。 [流覽](priva-overview.md)檔。
